...
export default function SettingsPage() {
  ...
  // Get store ID from localStorage or auth store
  const storeId = localStorage.getItem("store_id") || settings.store_id;
  ...
  return (
    <Container size="lg" px={0}>
      <Stack gap="lg">
        ...
        <Tabs defaultValue="display" variant="pills">
          <Tabs.List>
            <Tabs.Tab value="display" leftSection={<IconEyeOff size="1rem" />}>
              إعدادات العرض
            </Tabs.Tab>
          ...
          <Tabs.Panel value="display" pt="lg">
                ...
                <div>
                  ...
                  <Stack gap="md">
                    ...
                    <div>
                        ...
                        label={
                          <div>
                            ...
                            <Text size="xs" c="dimmed" mt={4}>
                              إخفاء أزرار "إضافة للسلة" و "اشتر الآن" الافتراضية
                              من سلة في صفحات المنتجات التي تحتوي على باقات نشطة
                            </Text>
                          </div>
                        }
                      ...
                      >
                        <Text size="sm">
                          <strong>ملاحظة:</strong> عند تفعيل هذا الخيار، سيتم
                          إخفاء أزرار سلة الافتراضية في صفحات المنتجات التي
                          لديها باقات نشطة فقط. سيظهر بدلاً منها زر الباقة الخاص
                          بك. هذا يساعد على تجنب الارتباك ويشجع العملاء على
                          اختيار الباقات.
                        </Text>
                      </Alert>
                    </div>
                    ...
                    <div>
                      <Switch
                        ...
                        label={
                          <div>
                            ...
                            <Text size="xs" c="dimmed" mt={4}>
                              إخفاء النافذة المنبثقة الافتراضية من سلة التي تظهر
                              عند وجود عروض خاصة على المنتج
                            </Text>
                          </div>
                        }
                      ...
                      >
                        <Text size="sm">
                          <strong>ملاحظة:</strong> هذا الخيار يخفي النافذة
                          المنبثقة الافتراضية من سلة
                          (s-offer-modal-type-products) فقط. النوافذ الأخرى من
                          سلة ستعمل بشكل طبيعي.
                        </Text>
                      </Alert>
                    </div>
                    ...
                    <div>
                      ...
                      >
                        <Text size="sm">
                          <strong>ملاحظة:</strong> هذا الخيار يخفي قسم خيارات
                          المنتج الافتراضي (salla-product-options) الموجود داخل
                          النموذج (product-form) في صفحة المنتج المستهدف فقط عند
                          وجود عروض باقات عليه. هذا يمنع الارتباك ويوجه العميل
                          لاختيار الخيارات من نافذة الباقة.
                        </Text>
                      </Alert>
                    </div>
                    ...
                    <div>
                        ...
                        label={
                          <div>
                            ...
                            <Text size="xs" c="dimmed" mt={4}>
                              ...
                              salla-quantity-input) في المنتج المستهدف عند وجود
                              عروض باقات نشطة عليه
                            </Text>
                          </div>
                        }
                      ...
                      >
                        <Text size="sm">
                          ...
                          المنتج المستهدف فقط عند وجود عروض باقات عليه. يتم
                          اختيار الكمية من خلال نافذة الباقة.
                        </Text>
                      </Alert>
                    </div>
            ...
            >
              <Stack gap="md">
                ...
                <Alert color="yellow" variant="light">
                  <Text size="xs">
                    سيتم إخفاء أزرار "إضافة للسلة" و "اشتر الآن" في المنتجات
                    التي لديها باقات نشطة فقط. سيظهر بدلاً منها زر الباقة الخاص
                    بك.
                  </Text>
                </Alert>
              </Stack>
            ...
            >
              <Stack gap="md">
                <Text size="sm" c="dimmed">
                  هذه هي النافذة المنبثقة الافتراضية من سلة التي سيتم إخفاؤها
                  عند تفعيل الخيار:
                </Text>
                <Image
                  src="/salla-model.png"
            ...
            >
              <Stack gap="md">
                <Text size="sm" c="dimmed">
                  هذا هو قسم خيارات المنتج (salla-product-options) الذي سيتم
                  إخفاؤه عند تفعيل الخيار:
                </Text>
                <Image
                ...
                <Alert color="yellow" variant="light">
                  <Text size="xs">
                    سيتم إخفاء قسم خيارات المنتج الافتراضي في صفحة المنتج
                    المستهدف فقط عند وجود عروض باقات نشطة عليه. سيختار العميل
                    الخيارات من نافذة الباقة بدلاً من ذلك.
                  </Text>
                </Alert>
              </Stack>
            </Modal>
            ...
            >
              <Stack gap="md">
                <Text size="sm" c="dimmed">
                  هذا هو قسم الكمية (parent section of salla-quantity-input)
                  الذي سيتم إخفاؤه عند تفعيل الخيار:
                </Text>
                <Image
                  src="/salla-qta.png"
                ...
                <Alert color="yellow" variant="light">
                  <Text size="xs">
                    سيتم إخفاء قسم الكمية الافتراضي في صفحة المنتج المستهدف فقط
                    عند وجود عروض باقات نشطة عليه. يتم اختيار الكمية من خلال
          ...
          <Tabs.Panel value="timer" pt="lg">
            {storeId && <TimerSettings storeId={storeId} />}
            {!storeId && (
              <Alert
                color="yellow"
                variant="light"
              ...
              >
                <Text size="sm">
                  معرف المتجر غير متوفر. يرجى تسجيل الدخول مرة أخرى.
                </Text>
              </Alert>
            )}
          </Tabs.Panel>
