      ...
      {freeShipping.enabled && (
        <>
          ...
          <Alert color="gray" variant="light" mt="md">
            ...
            {(freeShippingMode === "always" ||
              ...
              <div
                style={{
                  ...
                  padding: "12px 16px",
                  marginBottom: "12px",
                  background: freeShippingBgColor,
                  borderRadius: `${freeShippingBorderRadius}px`,
              ...
              >
                <span
                  ...
                  dangerouslySetInnerHTML={{ __html: freeShippingIcon }}
                />
            ...
            {freeShippingMode === "min_price" && freeShippingMinPrice > 0 && (
              <div
                style={{
                  display: "flex",
              ...
              >
                ...
                >
                  ...
                  <span style={{ flex: 1, textAlign: "center" }}>
                    {freeShippingProgressText.replace("{amount}", "50.00")}
                  </span>
                </div>
                <div
                  style={{
                    width: "100%",
                    background: freeShippingProgressBgColor,
                    borderRadius: "20px",
                    height: "8px",
                    overflow: "hidden",
                  }}
                >
                  <div
                    style={{
                      width: "60%",
                      background: freeShippingProgressColor,
                      height: "100%",
                      borderRadius: "20px",
                    }}
                  ></div>
