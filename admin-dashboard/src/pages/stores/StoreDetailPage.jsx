        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
              ...
              {store.plan_override_enabled && !store.is_unlimited && (
...
function EditStoreForm({ store, plans, onSubmit }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {isUnlimited && (
        <div className="p-4 bg-green-50 border border-green-200 rounded-lg flex items-start gap-3 dark:bg-green-900/20 dark:border-green-900/30">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-green-700 dark:text-green-500 mt-1">
              This store has unlimited access. All plan limits are bypassed -
              unlimited bundles and unlimited monthly views.
            </p>
          </div>
        </div>
      )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              disabled={!isOverrideMode || isUnlimited}
          ...
          <div>
            ...
            <input
              ...
              disabled={!isOverrideMode || isUnlimited}
              placeholder={
                isUnlimited ? "∞ Unlimited" : "Leave empty for unlimited"
              }
              className="w-full px-3 py-2 border rounded-lg border-zinc-300 focus:ring-black focus:border-black dark:bg-zinc-800 dark:border-zinc-700 dark:text-white disabled:opacity-50 disabled:cursor-not-allowed"
            />
          </div>
          ...
          <div className="pt-3 border-t border-zinc-100 dark:border-zinc-800">
            <label className="flex items-start gap-3 cursor-pointer">
              <input
                ...
                className="w-4 h-4 mt-0.5 text-green-600 rounded border-gray-300 focus:ring-green-500 dark:bg-zinc-700 dark:border-zinc-600"
              />
              <div>
                <span className="text-sm font-medium text-gray-900 dark:text-white flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-600 dark:text-green-400" />
                  Unlimited Access (Admin Override)
                </span>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  Bypass all plan limitations. Store will have unlimited bundles
                  and unlimited monthly views regardless of plan tier.
                </p>
              </div>
            </label>
          </div>
